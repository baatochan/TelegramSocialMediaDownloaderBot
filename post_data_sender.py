...
class PostDataSender:
    ...
    def send_post_to_tg(self, orig_tg_msg, handler_response, msg_to_reply_to=None, caption_suffix=""):
        caption = self.prepare_caption(handler_response)
        ...
        match (handler_response['type']):
            case "media":
                return self.send_media_post(orig_tg_msg, handler_response, caption, msg_to_reply_to)
            case "text":
    ...
    def prepare_caption(self, handler_response):
        long_caption = ""
        short_caption = ""
        if "text" in handler_response:
            handler_response['text'] = self.remove_hashtags(handler_response['text'])
        ...
        if handler_response['site'] == "twitter" and "community_note" in handler_response and handler_response['community_note'] == True:
            long_caption += self.parse_community_notes(handler_response)
    ...
    def parse_community_notes(self, handler_response):
    ...
    def send_media_post(self, orig_tg_msg, handler_response, caption, msg_to_reply_to):
    ...
    def send_singular_media_post(self, orig_tg_msg, handler_response, caption, msg_to_reply_to):
    ...
    def send_multiple_media_post(self, orig_tg_msg, handler_response, caption, msg_to_reply_to):
        media_group = []
        i = 0
